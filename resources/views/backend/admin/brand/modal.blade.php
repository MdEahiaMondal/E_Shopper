        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="name"><h3>Brand Name<sup class="star-danger">*</sup></h3></label>
                    <input type="text" class="form-control" value="{{old('name')}}" name="name" id="name" placeholder="Enter Brand Name" >
                </div>
                <div class="form-group">
                ...
                <div class="form-group form-check brand_checkbox">
                    <label class="form-check-label">
                        <input class="form-check-input"   type="checkbox" id="status" name="status" value="1"> Brand Status
                    </label>
                </div>
            </div>
