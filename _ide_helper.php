 ...
 * Generated for Laravel 5.8.33 on 2019-09-18 00:15:22.
 *
...
namespace Gloudemans\Shoppingcart\Facades { 
    ...
    class Cart {
         ...
         * @static 
         */ 
        public static function add($id, $name = null, $qty = null, $price = null, $weight = 0, $options = array())
        {
                        /** @var \Gloudemans\Shoppingcart\Cart $instance */
         ...
         * @static 
         */ 
        public static function addCartItem($item, $keepDiscount = false, $keepTax = false)
        {
                        /** @var \Gloudemans\Shoppingcart\Cart $instance */
                        return $instance->addCartItem($item, $keepDiscount, $keepTax);
        }
         ...
         * @static 
         */ 
        public static function merge($identifier, $keepDiscount = false, $keepTax = false)
        {
                        /** @var \Gloudemans\Shoppingcart\Cart $instance */
                        return $instance->merge($identifier, $keepDiscount, $keepTax);
        }
